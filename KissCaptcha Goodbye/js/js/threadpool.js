// I am waaay too lazy to write this from scratch
// From Here:
// http://www.smartjava.org/content/html5-easily-parallelize-jobs-using-web-workers-and-threadpool

// In the future, we will put this in background JS and use it for other things, like  
// which is why this is a pool and not just spamming 5 temp workers
...
function WorkerThread(parentPool) {
    ...
    this.run = function (workerTask) {
        ...
        if (this.workerTask.script != null) {
            var worker = new Worker(chrome.runtime.getURL(workerTask.script));
