...
// AFAIK Import JS is NOT POSSIBLE at this time in chrome extension web workers.  
// I do not plan to solve this problem so we will just dump the required code into the same file

// Visual Studio auto-formats it from a minified code block.  I don't care, not gonna fight the IDE for something trivial
...
function GetHash(datablock)
{
    var url = datablock.url;
            ...
            xhr.onload = function ()
            {
                if (xhr.status === 200)
                {
                    ...
                    reader.onload = function (e)
                    {
                        ...
                        datablock.hash = CryptoJS.MD5(CryptoJS.enc.Latin1.parse(contents)).toString();
                        resolve(datablock);
                    };
                } else
                {
